 ...
 const botonExtra = true;
  ...
  <div ref={componentRef} className="mt-20 mb-24">
    ...
    <>
      ...
      <h1 className= "text-center font-bold font-pop text-5xl uppercase mb-12 textGradient " >Proceso del seguimiento</h1>
      ...
      <div  className="linea" >
        ...
        <div className="contenedor bottomContenedor">
          <img src={seis} alt="" />
          <h2 className="text-sm font-pop font-bold">Cumplimiento H&S</h2>
