    ...
    <>
      ...
      <div  className="linea" >
        ...
        <div className="contenedor topContenedor">
            <img src={uno} alt="" />
            <h2 className=" text-base font-pop font-semibold ">Prevaloracion</h2>
        ...
        <div className="contenedor bottomContenedor">
          <img src={dos} alt="" />
          <h2 className="text-base font-pop font-semibold">Registro</h2>
        ...
        <div className="contenedor topContenedor">
            <img src={tres} alt="" />
            <h2 className="text-base font-pop font-semibold">Precalificacion</h2>
        ...
        <div className="contenedor bottomContenedor">
          <img src={cuatro} alt="" />
          <h2 className="text-base font-pop font-semibold">Acceso a SRM</h2>
        ...
        <div className="contenedor topContenedor">
            <img src={cinco} alt="" />
            <h2 className="text-base font-pop font-semibold">Registro de unidad y operador</h2>
        ...
        <div className="contenedor bottomContenedor">
          <img src={seis} alt="" />
          <h2 className="text-base font-pop font-semibold">Cumplimiento H&S</h2>
        ...
        <div className="contenedor topContenedor">
            <img src={siete} alt="" />
            <h2 className="text-base font-pop font-semibold">Arribo a planta</h2>
        ...
        <div className="contenedor bottomContenedor">
          <img src={ocho} alt="" />
          <h2 className="text-base font-pop font-semibold">salida de planta</h2>
